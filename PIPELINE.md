...
│   └── ...
└── processed_data/           # Output (created by pipeline)
...
Output files:
  - Chunks: ./processed_data/chunks.jsonl
...
# Load chunks
loader = JSONLLoader("processed_data/chunks.jsonl", jq_schema=".text")
...
- Check raw_data files for corruption
